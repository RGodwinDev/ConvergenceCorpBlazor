public static class Groups
{
    ...
    */
    ...
    {   //31 is all Soto, 448 is all JW
        ...
        SkeinGang.AddRun(new GroupRun("NA", new DateTime(2025, 10, 13, 1, 00, 00, DateTimeKind.Utc), 31));
        SkeinGang.AddRun(new GroupRun("NA", new DateTime(2025, 10, 19, 3, 00, 00, DateTimeKind.Utc), 448));
        SkeinGang.AddRun(new GroupRun("NA", new DateTime(2025, 10, 20, 1, 00, 00, DateTimeKind.Utc), 31));
        SkeinGang.AddRun(new GroupRun("NA", new DateTime(2025, 10, 26, 3, 00, 00, DateTimeKind.Utc), 448));
        SkeinGang.AddRun(new GroupRun("NA", new DateTime(2025, 10, 27, 1, 00, 00, DateTimeKind.Utc), 31));
